...
export default function MultiplayerForm() {
  ...
  //if data is not available, keep loading...
  if (!data) {
    return (
  ...
  const { theme, title, content } = data.toObject();
  ...
  return (
    <div className={styles.container}>
      ...
      >
        ...
        <div className={styles.preview_content}>{content}</div>
      </div>
      <div className={styles.form_container}>
        <div className={styles.form_content}>
          <Avatars />
          <form className={styles.form} onSubmit={(e) => e.preventDefault()}>
            <h2 className={styles.heading}>Writers Club</h2>
            <p className={styles.description}>
            Write your content in collaboration with your fellow writers!
            </p>
            ...
            <div className={styles.form_group}>
              ...
              <div className={styles.selection_container}>
                <textarea
                  ...
                  onBlur={() => updateMyPresence({ focusedId: null })}
                  onChange={(e) => {
                    data.set("content", e.target.value);
                  }}
                />

                <Selections id="input-content" />
              </div>
            </div>
